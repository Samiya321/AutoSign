...
sys.path.append("AutoSign/function/meituan")
...
def sendtg():
    global pushPlusToken,webhook,a
    message = a._buff
    datas=bytes(urllib.parse.urlencode({"title":"天天神券推送","content":message,"template":"markdown","callbackUrl":""}),encoding="UTF-8")
    sendNotify.send(Self,title="美团外卖神券领取成功", msg=datas)    
